...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 --master_port=29505 -m scripts.train --config /data/public/NAS/VLANeXt/config/sim_train_insertion_config.yaml
