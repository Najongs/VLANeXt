...
CUDA_VISIBLE_DEVICES=0,1,2 torchrun --nproc_per_node=3 --master_port=29505 -m scripts.train --config /data/public/NAS/VLANeXt/config/sim_train_align_config.yaml
