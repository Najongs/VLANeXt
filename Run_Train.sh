...
CUDA_VISIBLE_DEVICES=0,1,2,3,4 torchrun --nproc_per_node=5 --master_port=29505 -m scripts.train --config /home/najo/NAS/VLANeXt/config/sim_train_align_config.yaml
