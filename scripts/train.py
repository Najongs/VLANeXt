...
from src.datasets.sim_act_approach import SimActApproach
from src.datasets.sim_act_basic import SimActBasic
...
def train(config):
    ...
    if dataset_name == "droid":
        fps = 15.0
    elif dataset_name in ("sim", "sim_align", "sim_insertion", "sim_approach", "sim_basic"):
        fps = 15.0
    ...
    def create_dataloader(history_len):
        ...
        elif dataset_name == "sim_approach":
            ds = SimActApproach(
                data_dir=sim_path,
