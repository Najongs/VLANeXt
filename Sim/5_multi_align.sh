...
python run_parallel.py --script approach --workers 1 --episodes 5 \
    --base-dir /data/public/NAS/VLANeXt/dataset/approach/approach_00 --phantom-pos 0.0 -0.0 --no-side-camera --no-insertion --hold-steps 20 --cameras top_camera
python run_parallel.py --script approach --workers 1 --episodes 5 \
    --base-dir /data/public/NAS/VLANeXt/dataset/approach/approach_01 --phantom-pos 0.0 -0.1 --no-side-camera --no-insertion --hold-steps 20 --cameras top_camera
python run_parallel.py --script approach --workers 20 --episodes 250 \
    --base-dir /data/public/NAS/VLANeXt/dataset/approach/approach_03 --phantom-pos 0.0 -0.3 --no-side-camera --no-insertion --hold-steps 20 --cameras top_camera
python run_parallel.py --script approach --workers 1 --episodes 5 \
    --base-dir /data/public/NAS/VLANeXt/dataset/approach/approach_04 --phantom-pos 0.0 -0.4 --no-side-camera --no-insertion --hold-steps 20 --cameras top_camera
