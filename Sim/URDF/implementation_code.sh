xacro Insertion_task.xacro > combined_model.urdf
C:\Users\DGIST\Desktop\mujoco-3.4.0-windows-x86_64\bin\compile.exe combined_model.urdf meca_scene22.xml -y
