...
# Action normalization stats for align-only dataset
# delta_pose(6) + gripper(1)
action_min_sim_align = [-1.9950628280639648, -1.9578518867492676, -1.855233907699585, -0.043651919811964035, -0.043956458568573, -0.08516393601894379, -1.0]
action_max_sim_align = [1.9631338119506836, 1.9140794277191162, 1.8595972061157227, 0.03279181942343712, 0.03137323260307312, 0.03784353286027908, -1.0]
