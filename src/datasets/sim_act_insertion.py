...
# Action normalization stats for insertion dataset
# Insertion actions are smaller/slower than align — reuse align stats initially,
...
action_min_sim_insertion = [-0.5957266092300415, -0.6034851670265198, -0.5240848660469055, -0.002589409239590168, -0.0008707013912498951, -0.003319802926853299, -1.0]
action_max_sim_insertion = [0.5957266092300415, 0.6034851670265198, 0.5240848660469055, 0.002589409239590168, 0.0008707013912498951, 0.003319802926853299, 1.0]
...
class SimActInsertion(IterableDataset):
    """
    HDF5-based IterableDataset for insertion-only simulation data.
    Same structure as SimActAlign but with insertion instruction and normalization.
    Gripper is always closed (1.0) during insertion.
    """
    ...
    def __init__(
        ...
        self.action_min = np.array(action_min_sim_insertion, dtype=np.float32)
