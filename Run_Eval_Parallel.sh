...
#
# Examples:
# bash Run_Eval_Parallel.sh align /data/public/NAS/VLANeXt/output_dir_align_0505 --phantom-pos 0.0 0.0 --retreat-mm 2 --max-steps 300 --eval-seed 2026 --perturb-mode grid --xy-steps 5 --z-steps 2 --angle-steps 1 --repeats 1
