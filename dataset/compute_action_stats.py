...
Usage:
    python dataset/compute_action_stats.py --data_dir /home/najo/NAS/VLANeXt/dataset/approach/approach_00/collected_data_merged
    python dataset/compute_action_stats.py --data_dir /home/najo/NAS/VLANeXt/dataset/fine_align/approach_test/collected_data_merged --proprio   # include proprio stats
"""
